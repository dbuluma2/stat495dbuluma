...
(Hssina et al.~2021; APXML 2025).

\subsection{What SVD Does (High-Level)}\label{what-svd-does-high-level}

SVD takes the large, sparse user--item ratings matrix (R) and decomposes
it into three smaller matrices:
