...
[**Open Dashboard on Tableau Public**](https://public.tableau.com/views/TP_ecommerce_dashboard/Dashboard1?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

```{=html}
<div class='tableauPlaceholder' id='viz1759808150495' style='position: relative'>
  <noscript>
    <a href='#'>
      <img 
        alt='ECOMMERCE SALES DASHBOARD | YTD SALES ANALYSIS' 
        src='https://public.tableau.com/static/images/TP/TP_ecommerce_dashboard/Dashboard1/1_rss.png' 
        style='border: none' 
      />
    </a>
  </noscript>
  ...
  <object class='tableauViz' style='display:none;'>
    ...
    <param name='name' value='TP_ecommerce_dashboard/Dashboard1' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/TP/TP_ecommerce_dashboard/Dashboard1/1.png' />
...
<script type='text/javascript'>
  var divElement = document.getElementById('viz1759808150495');
